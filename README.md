...
- jshint : This runs jshint on each individual source file using the options found in the .jshintrc file, and fails the build if any warnings are generated by jshint.
